#include <quick_settings_layer.hpp>

QuickSettingsLayer* QuickSettingsLayer::create() {
...
CCArray* QuickSettingsLayer::createSettingsArray() {
...
void QuickSettingsLayer::onToggle(CCObject* pSender) {
...
void QuickSettingsLayer::onClose(CCObject* pSender) {
  auto manager = QuickSettingsManager::sharedManager();
